...
CONSUMERS = (
    ...
    ImageConsumer(
        "stalwart_cli",
        "argocd/platform/messaging/stalwart/resources/authentik-oidc-configuration-job.yaml",
...
def validate(write: bool) -> int:
    ...
    for consumer in CONSUMERS:
        ...
        if match is None:
            errors.append(f"{consumer.path}: image consumer {consumer.repository!r} was not found")
            continue
