...
| `forgejo-woodpecker-oauth.py` | `deploy` | Создаёт system-wide Forgejo OAuth2 application для Woodpecker и сохраняет credentials в OpenBao; ротация требует явного флага. |
